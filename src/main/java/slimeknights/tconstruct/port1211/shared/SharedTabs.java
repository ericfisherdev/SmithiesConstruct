 ...
 *
 * <p>Title comes from the lang key {@code itemGroup.tconstruct} (provided by the lang
...
public final class SharedTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> GENERAL = TinkerRegistries.CREATIVE_TABS.register("general",
            () -> CreativeModeTab.builder().title(Component.translatable("itemGroup.tconstruct")).icon(() -> new ItemStack(SharedItems.INGOT_COBALT.get())).displayItems((params, output) -> {
     ...
     * {@code TConstruct} after every content-owning class has been initialised so its lists
