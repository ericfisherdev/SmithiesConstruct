 ...
 * via {@link slimeknights.sconstruct.port1211.tools.ToolHelper}). The {@code level} parameter
 * is the player's accumulated count of this modifier on the stack (read off
 * {@link slimeknights.sconstruct.port1211.tools.ToolHelper#getModifierLevel}); a {@code 0}
...
public interface Modifier {
     ...
     * {@code > 0}, in {@link slimeknights.sconstruct.port1211.common.data.ToolModifiers}
     * insertion order.
     */
     ...
     * {@link slimeknights.sconstruct.port1211.common.data.ToolPersistentData} that subsequent
     * hooks read from.
     */
