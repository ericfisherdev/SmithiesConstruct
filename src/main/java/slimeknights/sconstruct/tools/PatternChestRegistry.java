...
import slimeknights.sconstruct.tools.block.PatternChestBlock;
 ...
 * {@link slimeknights.sconstruct.tools.item.ToolItems}.
 *
 ...
 * {@link slimeknights.sconstruct.tools.item.ToolItems} when that pulse lands. Until
 * then, {@link slimeknights.sconstruct.SConstruct} drives both {@link #init()} and
...
public final class PatternChestRegistry {
     ...
     * {@link slimeknights.sconstruct.tools.item.ToolItems#registerCreativeTabContents}
