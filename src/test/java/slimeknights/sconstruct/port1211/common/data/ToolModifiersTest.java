...
class ToolModifiersTest {
    ...
    private static final ResourceLocation REINFORCED = ResourceLocation.fromNamespaceAndPath("sconstruct", "reinforced");
    ...
    void withAddsANewModifierAppendingToTheEndOfTheIterationOrder() {
        ToolModifiers updated = fixture().with(ResourceLocation.fromNamespaceAndPath("sconstruct", "luck"), 1);

        assertIterableEquals(List.of(SHARPNESS, HASTE, REINFORCED, ResourceLocation.fromNamespaceAndPath("sconstruct", "luck")), updated.levels().keySet(),
