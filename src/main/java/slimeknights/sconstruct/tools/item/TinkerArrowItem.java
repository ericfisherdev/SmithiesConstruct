 ...
 * stack carries the same {@link slimeknights.sconstruct.common.data.ToolMaterials}
 * and {@link slimeknights.sconstruct.common.data.ToolStats} components every other
 * {@link ToolCore} ships with, so {@link slimeknights.sconstruct.tools.ToolHelper#rebuildStats}
 ...
 * {@link slimeknights.sconstruct.tools.entity.TinkerArrowEntity} on release; the
