 ...
 * built {@link slimeknights.sconstruct.tools.item.ToolCore} stack from positional
 * {@link slimeknights.sconstruct.tools.item.MaterialItem} parts. Same block / BE / menu
 ...
 * (which widens the candidate roster from {@link slimeknights.sconstruct.tools.ToolDefinition#ALL_BASIC}
 * to {@link slimeknights.sconstruct.tools.ToolDefinition#ALL_ADVANCED}).
 */
