...
public final class TinkerLanguageProvider extends LanguageProvider {
     ...
     * {@code shuriken} lives here too even though it is not in {@link slimeknights.sconstruct.tools.item.ToolItems#ALL_TOOLS}
    ...
    /**
     * Tool-part display names keyed by {@link slimeknights.sconstruct.tools.PartType#id()}.
    ...
    protected void addTranslations() {
        ...
        for (net.neoforged.neoforge.registries.DeferredItem<? extends slimeknights.sconstruct.tools.item.ToolCore> holder : slimeknights.sconstruct.tools.item.ToolItems.ALL_TOOLS) {
        ...
        add(slimeknights.sconstruct.tools.item.ToolItems.SHURIKEN.get(), shurikenName);
        ...
        for (slimeknights.sconstruct.tools.PartType part : slimeknights.sconstruct.tools.PartType.values()) {
            ...
            add(slimeknights.sconstruct.tools.item.ToolParts.get(part).get(), name);
        }
        ...
        add(SharedItems.MATERIALS_BOOK.get(), "Materials and You");
        ...
        for (Map.Entry<SlimeColor, slimeknights.sconstruct.world.block.SlimePlantSet> entry : WorldBlocks.PLANT_SETS.entrySet()) {
            String colorId = entry.getKey().id();
            String display = Character.toUpperCase(colorId.charAt(0)) + colorId.substring(1);
            slimeknights.sconstruct.world.block.SlimePlantSet set = entry.getValue();
        ...
        add(slimeknights.sconstruct.world.WorldEntities.BLUESLIME.get(), "Blueslime");
        add(slimeknights.sconstruct.world.WorldEntities.HUGESLIME.get(), "Huge Slime");
        ...
        add(slimeknights.sconstruct.gadgets.GadgetItems.SLING_BLUE.get(), "Blue Slimesling");
        add(slimeknights.sconstruct.gadgets.GadgetItems.SLING_PURPLE.get(), "Purple Slimesling");
        add(slimeknights.sconstruct.gadgets.GadgetItems.SLING_MAGMA.get(), "Magma Slimesling");
        add(slimeknights.sconstruct.gadgets.GadgetItems.SLING_BLOOD.get(), "Blood Slimesling");
        add(slimeknights.sconstruct.gadgets.GadgetItems.THROWBALL_BLUE.get(), "Blue Throwball");
        add(slimeknights.sconstruct.gadgets.GadgetItems.THROWBALL_PURPLE.get(), "Purple Throwball");
        add(slimeknights.sconstruct.gadgets.GadgetItems.THROWBALL_MAGMA.get(), "Magma Throwball");
        add(slimeknights.sconstruct.gadgets.GadgetItems.THROWBALL_BLOOD.get(), "Blood Throwball");
        add(slimeknights.sconstruct.gadgets.GadgetItems.PIGGYBACK.get(), "Piggyback");
        add(slimeknights.sconstruct.gadgets.GadgetItems.GLOW_BALL.get(), "Glow Ball");
        add(slimeknights.sconstruct.gadgets.GadgetItems.WITHER_HEAD.get(), "Wither Head");
        add(slimeknights.sconstruct.gadgets.GadgetItems.SLIME_HELMET.get(), "Slime Helmet");
        add(slimeknights.sconstruct.gadgets.GadgetItems.SLIME_CHESTPLATE.get(), "Slime Chestplate");
        add(slimeknights.sconstruct.gadgets.GadgetItems.SLIME_LEGGINGS.get(), "Slime Leggings");
        add(slimeknights.sconstruct.gadgets.GadgetItems.SLIME_BOOTS.get(), "Slime Boots");
        add(slimeknights.sconstruct.gadgets.GadgetBlocks.DRYING_RACK.get(), "Drying Rack");
        add(slimeknights.sconstruct.gadgets.GadgetBlocks.WOODEN_HOPPER.get(), "Wooden Hopper");
        add(slimeknights.sconstruct.gadgets.GadgetBlocks.STONE_LADDER.get(), "Stone Ladder");
        add(slimeknights.sconstruct.gadgets.GadgetBlocks.DRIED_CLAY.get(), "Dried Clay");
        add(slimeknights.sconstruct.gadgets.GadgetBlocks.DRIED_CLAY_BRICK.get(), "Dried Clay Bricks");
