package slimeknights.sconstruct.lib.util;
 ...
 * ResourceLocation in the {@code sconstruct} namespace and propagates the underlying
...
class UtilTest {
    ...
    void rlReturnsTheTconstructNamespacedResourceLocation() {
        ...
        assertEquals(SConstruct.MOD_ID, result.getNamespace(), "rl() must namespace the location under sconstruct");
