...
class SharedClientFluidTypesTest {
    ...
    void stillAndFlowingTexturesPointAtTconstructFluidPaths() {
        assertAll(() -> assertEquals(ResourceLocation.fromNamespaceAndPath(TConstruct.MOD_ID, "block/fluid/bloodstill"), SharedClientFluidTypes.BLOOD_EXTENSIONS.getStillTexture()),
                () -> assertEquals(ResourceLocation.fromNamespaceAndPath(TConstruct.MOD_ID, "block/fluid/bloodflow"), SharedClientFluidTypes.BLOOD_EXTENSIONS.getFlowingTexture()));
    }
