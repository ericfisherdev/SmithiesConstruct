 ...
 * {@link TConstruct#MOD_ID tconstruct} namespace — a typo in the registry argument or path
...
class TinkerTagsTest {
    ...
    private static void assertTagBound(TagKey<?> tag, String expectedRegistryPath, String expectedTagPath) {
        ...
        assertEquals(TConstruct.MOD_ID, tag.location().getNamespace(), "TagKey should be namespaced under tconstruct");
