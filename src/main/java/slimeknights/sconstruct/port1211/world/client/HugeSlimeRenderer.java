 ...
 * the inherited {@link SmithiesSlimeRenderer#scale} reads {@code entity.getSize()} and applies
 * the same multiplier vanilla slimes use, so no renderer-side scale override is needed.
 */
public class HugeSlimeRenderer extends SmithiesSlimeRenderer<EntityHugeSlime> {
