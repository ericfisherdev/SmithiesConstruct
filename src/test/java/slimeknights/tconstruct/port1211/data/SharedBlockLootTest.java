...
class SharedBlockLootTest {
    ...
    private static final String LOOT_ROOT = "data/tconstruct/loot_table/blocks/";
    ...
    void metalStorageBlocksDropSelf() {
        ...
        assertAll(() -> assertEquals("minecraft:block", loot.get("type").getAsString()),
                () -> assertEquals("tconstruct:block_cobalt", firstItemEntry(loot), "metal storage block should drop its own item"),
    ...
    void decorativeBlocksDropSelf() {
        assertAll(() -> assertEquals("tconstruct:glow", firstItemEntry(loadTable("glow.json"))), () -> assertEquals("tconstruct:firewood", firstItemEntry(loadTable("firewood.json"))),
                () -> assertEquals("tconstruct:lavawood", firstItemEntry(loadTable("lavawood.json"))));
    }
